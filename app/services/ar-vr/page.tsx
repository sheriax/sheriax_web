    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
      ...
      >
        ...
        <p className="mt-4 text-xl text-foreground/70 max-w-4xl">
          ...
          with interactive AR/VR prototypes and production-ready apps.
          From concept to reality in virtual worlds.
        </p>
        <div className="mt-8 h-72 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-foreground/30 text-sm mt-2">&quot;Immersive AR/VR experience with headset and holograms&quot;</p>
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            ...
            <h3 className="font-medium">WebXR experiences for browser-based AR/VR</h3>
            <p className="text-foreground/70 text-sm mt-2">Cross-platform immersive web experiences accessible from any device.</p>
          </motion.div>
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            <Box className="w-7 h-7 text-pink-500 mb-3" />
            <h3 className="font-medium">3D asset pipelines and optimization</h3>
            <p className="text-foreground/70 text-sm mt-2">Efficient workflows for creating and optimizing 3D content.</p>
          </motion.div>
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            <Headphones className="w-7 h-7 text-blue-500 mb-3" />
            <h3 className="font-medium">Unity/Unreal prototyping</h3>
            <p className="text-foreground/70 text-sm mt-2">Rapid prototyping with industry-standard game engines.</p>
          </motion.div>
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            <Users className="w-7 h-7 text-green-500 mb-3" />
            <h3 className="font-medium">Spatial UX research & usability testing</h3>
            <p className="text-foreground/70 text-sm mt-2">Human-centered design for immersive experiences.</p>
          </motion.div>
        </div>
      </motion.section>
