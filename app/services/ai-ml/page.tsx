        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-foreground/70">
              ...
              predictive analytics to recommendation systems and anomaly
              detection.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-foreground/70">
              Sophisticated text analysis, chatbots, sentiment analysis, and
              language understanding systems for enhanced user experiences.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-foreground/70">
              ...
              decisions with advanced statistical modeling and machine learning
              algorithms.
            </p>
          </motion.div>
      ...
      >
        <div className="rounded-lg border border-white/10 p-8 text-center bg-gradient-to-r from-blue-500/5 to-purple-500/5">
          ...
          <p className="text-foreground/70 mb-6 max-w-2xl mx-auto">
            Let&apos;s discuss how AI and ML can elevate your operations,
            improve efficiency, and unlock new opportunities for growth and
            innovation.
          </p>
          <Link
            href="/contact"
