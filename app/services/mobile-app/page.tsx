    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
      ...
      >
        ...
        <p className="mt-4 text-xl text-foreground/70 max-w-4xl">
          Build high-quality cross-platform apps that feel native and perform
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-foreground/70 text-sm mt-2">
              Keep users engaged with smart triggers and routing.
            </p>
          </motion.div>
          <motion.div
            className="rounded-lg border border-white/10 p-6 hover:border-white/20"
          ...
          >
            ...
            <p className="text-foreground/70 text-sm mt-2">
              Resilient apps that work without connectivity.
            </p>
          </motion.div>
          <motion.div
            className="rounded-lg border border-white/10 p-6 hover:border-white/20"
          ...
          >
            ...
            <p className="text-foreground/70 text-sm mt-2">
              From submission to monitoring and growth.
            </p>
          </motion.div>
        </div>
      </motion.section>
