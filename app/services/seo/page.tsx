    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
      ...
      >
        ...
        <p className="mt-4 text-xl text-foreground/70 max-w-4xl">
          Improve your visibility and organic traffic with technical, on-page, and content SEO strategies.
          We build sustainable growth through data-driven optimization.
        </p>
        <div className="mt-8 h-72 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg flex items-center justify-center">
          <div className="text-center">
            <p className="text-foreground/50">SEO Hero Image Placeholder</p>
            <p className="text-foreground/30 text-sm mt-2">&quot;Search engine optimization dashboard with graphs and keywords&quot;</p>
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            ...
            <p className="text-foreground/70 text-sm mt-2">Crawlability, site speed, and structured data fixes.</p>
          </motion.div>
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            <Search className="w-7 h-7 text-green-500 mb-3" />
            <h3 className="font-medium">Keyword strategy & content planning</h3>
            <p className="text-foreground/70 text-sm mt-2">Map search intent to topics and content funnels.</p>
          </motion.div>
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            <Code2 className="w-7 h-7 text-purple-500 mb-3" />
            <h3 className="font-medium">On-page optimization & schema</h3>
            <p className="text-foreground/70 text-sm mt-2">Semantic HTML, metadata, and rich results markup.</p>
          </motion.div>
          <motion.div className="rounded-lg border border-white/10 p-6 hover:border-white/20" whileHover={{ y: -4 }}>
            <FileText className="w-7 h-7 text-yellow-500 mb-3" />
            <h3 className="font-medium">Monitoring & reporting</h3>
            <p className="text-foreground/70 text-sm mt-2">Dashboards for rankings, traffic, and conversions.</p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="rounded-lg border border-white/10 p-8 text-center">
          <h3 className="text-xl font-semibold">Ready to grow organic traffic?</h3>
