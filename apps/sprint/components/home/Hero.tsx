...
export function Hero() {
  return (
    <section className="relative overflow-hidden min-h-[85vh] flex items-center">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-brand-50/40 via-white to-stone-50/60" />
      ...
      <div className="absolute bottom-[-100px] left-[-150px] w-[400px] h-[400px] rounded-full bg-gradient-to-tr from-stone-100/40 to-transparent blur-3xl pointer-events-none" />
      {/* Decorative dots */}
      <div className="absolute top-40 right-28 w-2 h-2 rounded-full bg-brand-300/30 hidden lg:block" />
      <div className="absolute bottom-36 left-28 w-1.5 h-1.5 rounded-full bg-stone-300/30 hidden lg:block" />
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-20 sm:py-0 w-full">
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            className="mt-8 text-[2.5rem] sm:text-[3.25rem] lg:text-[4rem] font-bold text-stone-900 leading-[1.05] tracking-tight"
          >
          ...
          <motion.p
            variants={fadeUp}
            className="mt-6 text-lg text-stone-600 leading-relaxed max-w-xl"
          >
          ...
          <motion.div variants={fadeUp} className="mt-10 flex flex-col sm:flex-row gap-3">
            ...
            <a
              href="#packages"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 text-sm font-semibold text-stone-600 bg-white/80 border border-stone-200 rounded-full hover:border-stone-300 hover:bg-white transition-all"
            >
              View Offers ↓
            </a>
          </motion.div>
