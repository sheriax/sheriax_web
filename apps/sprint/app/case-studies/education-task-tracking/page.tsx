              ...
              <div className="space-y-4 text-[15px] text-stone-600 leading-[1.8]">
                ...
                <ul className="space-y-3 ml-4">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span><strong className="text-stone-800">Centralized task intake:</strong> A single form replaces scattered messages. When a task is submitted, it auto-assigns to the right person based on workload and expertise tags — no manual delegation needed.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="flex-shrink-0 mt-2 w-1.5 h-1.5 rounded-full bg-brand-500" />
                    <span><strong className="text-stone-800">Automated deadline enforcement:</strong> Reminders trigger at 48h, 24h, and 4h before due dates. Overdue items escalate automatically. Nothing slips through because someone forgot to check.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="flex-shrink-0 mt-2 w-1.5 h-1.5 rounded-full bg-brand-500" />
                    <span><strong className="text-stone-800">Live progress visibility:</strong> A dashboard shows task status, blockers, and completion rates per team member — in real time. The weekly status meeting shrinks from 45 minutes to 10.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="flex-shrink-0 mt-2 w-1.5 h-1.5 rounded-full bg-brand-500" />
                    <span><strong className="text-stone-800">Notification integrations:</strong> Slack, email, or push notifications keep everyone in sync without manual check-in messages. Updates happen in context, not in a separate thread.</span>
                  </li>
                </ul>
              </div>
            </section>
