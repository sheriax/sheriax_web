      ...
      <article className="min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 pt-32 pb-20 sm:pt-40 sm:pb-28">
              ...
              <div className="space-y-4 text-[15px] text-zinc-600 leading-[1.8]">
                ...
                <ul className="space-y-2 ml-4">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span><strong className="text-zinc-800">Client Onboarding:</strong> A new client form submission triggers a 12-step checklist auto-assigned to the relevant team members, with progress tracking and completion alerts. No steps get skipped because they&apos;re tracked, not remembered.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="flex-shrink-0 mt-2 w-1.5 h-1.5 rounded-full bg-brand-500" />
                    <span><strong className="text-zinc-800">Weekly Reporting:</strong> Data from multiple tools auto-pulls on schedule, compiles into a templated report, and sends to stakeholders — no manual copy-paste, no forgetting.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="flex-shrink-0 mt-2 w-1.5 h-1.5 rounded-full bg-brand-500" />
                    <span><strong className="text-zinc-800">Invoice Pipeline:</strong> Completed project milestones trigger invoice draft generation, approval routing, and send reminders — fully tracked from trigger to payment.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="flex-shrink-0 mt-2 w-1.5 h-1.5 rounded-full bg-brand-500" />
                    <span><strong className="text-zinc-800">Team Alerts:</strong> Escalation and standby notifications fire based on SLA timers, ensuring nothing sits unaddressed beyond defined thresholds.</span>
                  </li>
                </ul>
                <p>
          ...
          <div className="mt-14 pt-8 border-t border-zinc-100">
            <p className="text-base font-bold text-zinc-900 mb-5">Running operations on manual effort?</p>
