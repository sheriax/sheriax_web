      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 pt-32 pb-20 sm:pt-40 sm:pb-28">
          <div className="max-w-3xl">
            <span className="text-[11px] font-semibold tracking-widest uppercase text-brand-600">Case Studies</span>
                  ...
                  <div className="p-7 sm:p-8">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                      <div className="flex-1 max-w-2xl">
                        ...
                        <h2 className="mt-4 text-xl sm:text-2xl font-bold text-zinc-900 tracking-tight group-hover:text-brand-600 transition-colors">
                          {cs.title}
                        </h2>
                        <p className="mt-3 text-[15px] text-zinc-600 leading-relaxed">{cs.summary}</p>
                      </div>
                    ...
                    <div className="mt-6 pt-5 border-t border-zinc-100 flex flex-wrap gap-4">
                      {cs.metrics.map((m) => (
                        <span key={m} className="text-[13px] font-medium text-zinc-500 bg-zinc-50 px-3 py-1 rounded-full">
                          {m}
                        </span>
                      ))}
                    </div>
