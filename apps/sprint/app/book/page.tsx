  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 pt-28 pb-20 sm:pt-36 sm:pb-24">
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 shadow-lg overflow-hidden" style={{ minHeight: 500 }}>
          <div id="cal-inline" className="w-full" style={{ minHeight: 500 }}>
            <div className="flex flex-col items-center justify-center h-full min-h-[500px] p-8 text-center">
              ...
              <h3 className="text-lg font-semibold text-zinc-900 mb-2">Schedule a 30-Minute Call</h3>
              <p className="text-sm text-zinc-500 mb-6 max-w-sm">Click below to open our calendar and pick a time that works for you.</p>
