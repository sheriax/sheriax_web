        ...
        <div className="mt-20">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-5">
            <Card hover>
              ...
              <h3 className="mt-4 text-lg font-display text-zinc-900">Agency AI Automation Sprint</h3>
              <p className="mt-1 text-2xl font-bold text-zinc-900 font-mono tracking-tight">₹1,50,000</p>
              <p className="text-[11px] text-zinc-500 mt-0.5 tracking-wide">2 Weeks · AED 15,000+ for UAE</p>
            ...
            <Card hover>
              ...
              <h3 className="mt-4 text-lg font-display text-zinc-900">Workflow Discovery Sprint</h3>
              <p className="mt-1 text-2xl font-bold text-zinc-900 font-mono tracking-tight">₹50,000</p>
              <p className="text-[11px] text-zinc-500 mt-0.5 tracking-wide">3 Days · AED 2,500+ for UAE</p>
              <ul className="mt-4 space-y-2.5">
